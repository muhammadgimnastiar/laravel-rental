...
class EventService
{
    ...
    public function chargeHourlyRate($requestData, Car $car)
    {
        if (!$car->hourly_rate) {
            return true;
        }
        ...
        return auth()->user()->chargeCredits($totalHours, $car);
    }
}
